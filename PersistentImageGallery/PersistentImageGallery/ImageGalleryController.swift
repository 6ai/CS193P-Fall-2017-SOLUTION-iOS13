...
//
//  Created by aqune on 10/04/2020.
...
//        self.navigationItem.title = "HHHHHH"
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath)
        ...
        let cell = collectionView.dequeueReusableCell(
                ...
                for: indexPath as IndexPath) as! ImageGalleryCell
...
extension ImageGalleryController: UICollectionViewDragDelegate {
    ...
    private func dragItem(at indexPath: IndexPath) -> [UIDragItem] {
        guard let itemCell = collectionView?.cellForItem(at: indexPath) as? ImageGalleryCell,
        ...
        for item in coordinator.items {
            ...
            if let sourceIndexPath = item.sourceIndexPath, let image = item.dragItem.localObject as? Image {
                ...
                let placeholder = UICollectionViewDropPlaceholder(insertionIndexPath: destinationIndexPath,
                        reuseIdentifier: ImageGalleryCell.identifier)
