//
// Created by ccoleridge on 19/04/2020.
...
struct Images {
    static let urls: [URL?] = [
        ...
        URL(string: "https://images.unsplash.com/photo-1587298700182-cdc47d304d02?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80"),
        URL(string: "https://images.unsplash.com/photo-1587298426626-de33dda872ce?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80")
    ]
}